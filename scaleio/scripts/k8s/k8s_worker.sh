...
cp /home/vagrant/k8s_certs/kube-proxy.pem /var/lib/kubernetes/
cp /home/vagrant/k8s_certs/kube-proxy-key.pem /var/lib/kubernetes/
cp /home/vagrant/k8s_certs/admin.pem /var/lib/kubernetes/
cp /home/vagrant/k8s_certs/admin-key.pem /var/lib/kubernetes/
cp /home/vagrant/k8s_certs/bootstrap.kubeconfig /var/lib/kubelet
cp /home/vagrant/k8s_certs/kube-proxy.kubeconfig /var/lib/kube-proxy
rm -rf /home/vagrant/k8s_certs
ENP0S8IP=$(ip -o -4 addr show enp0s8 | awk -F '[ /]+' '/global/ {print $4}')
K8SCONTROLLERIP=192.168.50.12
...
kubectl config set-cluster scaleio-k8s --certificate-authority=/var/lib/kubernetes/ca.pem --embed-certs=true --server=https://${K8SCONTROLLERIP}:6443
